---
description: 議論型・多視点レース予想。Agent Teams を生成し、メンバー間で直接議論させて結論を出す。例 /debate 202605030811
---
...
1. race_id を抽出・正規化（keibalab 日付ベース形式 12桁 = YYYYMMDD+場コード+R）
